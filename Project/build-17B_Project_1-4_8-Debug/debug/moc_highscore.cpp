...
#include "../../17B_Project_1/highscore.h"
...
static const char qt_meta_stringdata_highscore[] = {
    "highscore\0\0on_backButton_clicked()\0"
};
...
void highscore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        highscore *_t = static_cast<highscore *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData highscore::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject highscore::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_highscore,
      qt_meta_data_highscore, &staticMetaObjectExtraData }
};
